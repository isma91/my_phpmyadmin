    ...
    function showColumns (dbName, tabName) {
        $.post('api/?showColumns', {databaseName: dbName, tableName: tabName}, function (tableColumns, textStatus) {
            if (textStatus === "success") {
                ...
                columns = '';
                columns = columns + '<table class="mui-table mui-body"><thead><tr><th>#</th><th>Field</th><th>Type</th><th>Null</th><th>Key</th><th>Default</th><th>Extra</th></tr></thead><tbody>';
            ...
            $.post('api/?showTables', {arrayDatabase: allDatabases}, function (allTables, textStatus) {
                if (textStatus === "success") {
                    ...
                    $("a.add_table").click(function () {
                        ...
                        addTable = '';
                        addTable = addTable + '<table class="responsive-table centered highlight mui-body"><thead><tr><th class="tooltipped" data-position="top" data-tooltip="The name of the column">Name</th><th class="tooltipped" data-position="top" data-tooltip="Type of the column">Type</th><th class="tooltipped" data-position="top" data-tooltip="The different values of columns of type enum/set are to be specified as \'a\',\'b\',\'c\'... To use a backslash (\\) or an apostrophe (\') in one of those values, precede it with a backslash (eg \'\\\\xyz\'or \'a\\\'b\')">Length/Value</th><th class="tooltipped" data-position="top" data-tooltip="For default values, please enter a single value, without escape character or apostrophes, such as: a">Default</th><th class="tooltipped" data-position="top" data-tooltip="Character set and value encoding">Collation</th><th class="tooltipped" data-position="top" data-tooltip="">Attributes</th><th class="tooltipped" data-position="top" data-tooltip="Can be null or not">Null</th><th class="tooltipped" data-position="top" data-tooltip="">Index</th><th class="tooltipped" data-position="top" data-tooltip="Auto Increment">A_I</th><th class="tooltipped" data-position="top" data-tooltip="Add a comment">Comment</th><th class="tooltipped" data-position="top" data-tooltip="">Type MIME</th><th class="tooltipped" data-position="top" data-tooltip="">Transformation</th><th class="tooltipped" data-position="top" data-tooltip="">Transformation Options</th></tr></thead><tbody>';
                        addTable = addTable + '<tr><td><div class="input-field"><input name="name" type="text"></div></td><td><select name="type"><optgroup label="TEXT"><option value="CHAR">CHAR</option><option value="VARCHAR">VARCHAR</option><option value="TEXT">TEXT</option><option value="TINYTEXT">TINYTEXT</option><option value="MEDIUMTEXT">MEDIUMTEXT</option><option value="LONGTEXT">LONGTEXT</option><option value="BLOB">BLOB</option><option value="MEDIUMBLOB">MEDIUMBLOB</option><option value="LONGBLOB">LONGBLOB</option><option value="ENUM">ENUM</option><option value="SET">SET</option></optgroup><optgroup label="NUMBERS"><option value="INT">INT</option><option value="TINYINT">TINYINT</option><option value="SMALLINT">SMALLINT</option><option value="MEDIUMINT">MEDIUMINT</option><option value="LONGINT">LONGINT</option><option value="FLOAT">FLOAT</option><option value="DOUBLE">DOUBLE</option><option value="DECIMAL">DECIMAL</option></optgroup><optgroup label="DATE"><option value="DATE">DATE</option><option value="DATETIME">DATETIME</option><option value="TIMESTAMP">TIMESTAMP</option><option value="TIME">TIME</option><option value="YEAR">YEAR</option></optgroup></select></td><td><div class="input-field"><input name="length/value" type="text"></div></td></tr></tbody></table>';
                        /*
                        <div class="mui-select">
                        <select name="type">
                        <option value="CHAR">CHAR</option><option value="VARCHAR">VARCHAR</option>
                        <option value="TEXT">TEXT</option><option value="TINYTEXT">TINYTEXT</option>
                        <option value="MEDIUMTEXT">MEDIUMTEXT</option><option value="LONGTEXT">LONGTEXT</option>
                        <option value="BLOB">BLOB</option><option value="MEDIUMBLOB">MEDIUMBLOB</option>
                        <option value="LONGBLOB">LONGBLOB</option><option value="ENUM">ENUM</option>
                        <option value="SET">SET</option>
                        <option value="INT">INT</option><option value="TINYINT">TINYINT</option>
                        <option value="SMALLINT">SMALLINT</option><option value="MEDIUMINT">MEDIUMINT</option>
                        <option value="LONGINT">LONGINT</option><option value="FLOAT">FLOAT</option>
                        <option value="DOUBLE">DOUBLE</option><option value="DECIMAL">DECIMAL</option>
                        <option value="DATE">DATE</option><option value="DATETIME">DATETIME</option>
                        <option value="TIMESTAMP">TIMESTAMP</option><option value="TIME">TIME</option>
